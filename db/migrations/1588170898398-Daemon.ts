...
export class Daemon1588170898398 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "daemon" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ownerId" uuid, CONSTRAINT "PK_5c09cb3f741a21cebb3fe015c6e" PRIMARY KEY ("id"))`, undefined);
